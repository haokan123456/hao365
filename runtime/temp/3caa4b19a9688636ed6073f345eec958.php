<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\www\hao365\public/../application/admin\view\index\index.html";i:1576293788;s:42:"../application/admin/view/common/head.html";i:1576293749;s:42:"../application/admin/view/common/left.html";i:1576293920;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <!-- Custom CSS -->
    <link href="/static/style/admin/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
...
<body>
        ...
        <div class="navbar-header" data-logobg="skin5">
            ...
            <a class="navbar-brand" href="index.html">
                ...
                <span class="logo-text">
                     <!-- dark Logo text -->
                     <h4 style='margin-top: 12px;'>hao365网址导航</h4>
    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav" class="p-t-30">
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="index.html" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">网站设置</span></a></li>
                
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:;" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">栏目管理 </span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item"><a href="<?php echo url('/admin/cate/index'); ?>" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">栏目设置</span></a></li>                                
                    </ul>
                </li>                        
                ...
                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="pages-elements.html" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">用户名管理</span></a></li>
            </ul>
        </nav>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="/static/style/admin/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="/static/style/admin/images/users/4.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="/static/style/admin/images/users/5.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40" src="/static/style/admin/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="/static/style/admin/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="/static/style/admin/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="/static/style/admin/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="custom-control custom-checkbox">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="/static/style/admin/images/users/1.jpg" alt="user"></div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="/static/style/admin/images/users/2.jpg" alt="user"></div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="/static/style/admin/images/users/3.jpg" alt="user"></div>
                                            <div class="chat-content">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="/static/style/admin/images/background/img4.jpg" class="img-fluid">
                                    </div>
                                </div>
    ...
    <!-- <script src="/static/style/admin/js/pages/dashboards/dashboard1.js"></script> -->
    <!-- Charts js Files -->
    <script src="/static/style/admin/libs/flot/excanvas.js"></script>
    <script src="/static/style/admin/libs/flot/jquery.flot.js"></script>
    <script src="/static/style/admin/libs/flot/jquery.flot.pie.js"></script>
    <script src="/static/style/admin/libs/flot/jquery.flot.time.js"></script>
    <script src="/static/style/admin/libs/flot/jquery.flot.stack.js"></script>
    <script src="/static/style/admin/libs/flot/jquery.flot.crosshair.js"></script>
    <script src="/static/style/admin/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="/static/style/admin/js/pages/chart/chart-page-init.js"></script>
